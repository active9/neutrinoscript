...
(function (exports) {
  ...
  Program.prototype.scan = function (o) {
    ...
    scope.addVariable(new Variable("$"), true);
    scope.addVariable(new Variable("top"), true);
    scope.addVariable(new Variable("Math"), true);
    scope.addVariable(new Variable("window"), true);
    scope.addVariable(new Variable("document"), true);
    scope.addVariable(new Variable("alert"), true);
    scope.addVariable(new Variable("confirm"), true);
    scope.addVariable(new Variable("Date"), true);
    scope.addVariable(new Variable("process"), true);
    scope.addVariable(new Variable("console"), true);
    scope.addVariable(new Variable("setTimeout"), true);
    scope.addVariable(new Variable("clearTimeout"), true);
    scope.addVariable(new Variable("setInterval"), true);
    scope.addVariable(new Variable("clearInterval"), true);
    scope.addVariable(new Variable("module"), true);
  ...
  VariableDeclaration.prototype.scan = function (o) {
    ...
    check(this.kind === "let" || this.kind === "const" || this.kind === "extern" || this.kind === "var",
